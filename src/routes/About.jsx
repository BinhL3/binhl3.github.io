...
const About = () => {
  return (
    ...
    <p>i don't think i'm that smart. but man do i try to work hard and learn as many things as possible. it might be this attitude that helped me graduate at the top of my school, get into every vietnamese college (can't say the same for the u.s. ones), and gain substantial success in social media.</p>
    <p>i really want to succeed in this tech world now. even given the prevalence of ai. even given the kids who coded since they was 6. i hope that showing up and persisting each day through all the struggles will pay off.</p>
