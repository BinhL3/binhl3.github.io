  ...
  return (
    ...
    <ul>
        <li>
            ...
            <div className="content">
            <span className="role"> 
                <a href="https://cci.drexel.edu/" target="_blank" rel="noopener noreferrer">
                    course assistant @ drexel
                </a>
            </span>
            <p className="description">teaching assistant for software engineering course se 320 concerning software validation and verification</p>
        ...
        <li>
            ...
            <p className="description">assisting the dean in managing student affairs and representing the student body in faculty meetings.</p>
    ...
    <ul>
        ...
        <li>
            ...
            <div className="content">
            <span className="role">
                <a href="https://codepath.org/" target="_blank" rel="noopener noreferrer">
                    fellow @ codepath
                </a>
            </span>
            <p className="description">took tip102 and participated in pair programming sessions with fellow fellows to prepare for technical interviews.</p>
            </div>
        </li>
